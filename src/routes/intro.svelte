<div
    class="bg-[url(/landscape9.jpg)] w-screen bg-cover bg-no-repeat flex flex-wrap justify-center items-center px-4 py-12 gap-4 lg:gap-8 lg:py-36"
>
    <img
    ...
    <div class="w-5/ md:w-1/2 bg-slate-800/70 backdrop-blur-sm rounded-md text-center font-mono text-white p-4">
        ...
        <p class="font-regular text-lg md:text-xl md:text-left md:indent-4">
