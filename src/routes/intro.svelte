...
>
    ...
    <div class="w-5/ md:w-1/2 bg-slate-800/70 backdrop-blur-sm rounded-md text-center font-mono text-white p-4">
        ...
        <p class="font-regular text-lg leading-relaxed lg:leading-relaxed md:text-xl md:indent-8">
            ...
            accessible, responsive, and readable code. My experience in both security and software gives me a more holistic
            understanding of each field, and my extensive work in development teams has taught me how to collaborate with both
            team members and stakeholders. <a
                class="text-blue-300 underline"
                target="_blank"
                href="https://www.blueprintboulder.org">Blueprint Boulder</a
            >
            has been an incredible part of my time at CU and my main extracurricular. I've worked in various roles for this club including
            co-president, project lead, webmaster, outreach, and a project team member. This has improved my consulting and communication
            skills as we work directly with nonprofits throughout the year.
        </p>
    </div>
</div>
